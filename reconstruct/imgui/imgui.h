...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChildImage(const char* str_id, ImTextureID texId, const ImVec2& size_arg, bool border, ImGuiWindowFlags extra_flags);
    ...
    IMGUI_API bool          VOwnSliderScalar(const char* label, const ImVec2& size,float value, float p_min, float p_max);
